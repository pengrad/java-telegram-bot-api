...
public class TelegramBot implements BotApi {
	...
	@Override
	public SendResponse sendMessage(@Field("chat_id") Integer chatId, @Field("text") String text,
	...
	@Override
	public Observable<SendResponse> sendMessageRx(@Field("chat_id") Integer chatId, @Field("text") String text,
			@Field("disable_web_page_preview") Boolean disableWebPagePreview,
			@Field("reply_to_message_id") Integer replyToMessageId, @Field("reply_markup") Keyboard replyMarkup) {
	...
	@Override
	public SendResponse forwardMessage(@Field("chat_id") Integer chatId, @Field("from_chat_id") Integer fromChatId,
			@Field("message_id") Integer messageId) {
		return botApi.forwardMessage(chatId, fromChatId, messageId);
	}

	@Override
	public SendResponse sendPhoto(@Part("chat_id") Integer chatId, @Part("photo") String photo,
	...
	@Override
	public SendResponse sendPhoto(@Part("chat_id") Integer chatId, @Part("photo") InputFile photo,
			@Part("caption") String caption, @Part("reply_to_message_id") Integer replyToMessageId,
			@Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendPhoto(chatId, photo, caption, replyToMessageId, replyMarkup);
	}
	...
	@Override
	public SendResponse sendPhoto(@Part("chat_id") Integer chatId, @Part("photo") InputFileBytes photo,
			@Part("caption") String caption, @Part("reply_to_message_id") Integer replyToMessageId,
			@Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendPhoto(chatId, photo, caption, replyToMessageId, replyMarkup);
	}
	...
	@Override
	public SendResponse sendAudio(@Part("chat_id") Integer chatId, @Part("audio") String audio,
	...
	@Override
	public SendResponse sendAudio(@Part("chat_id") Integer chatId, @Part("audio") InputFile audio,
			@Part("duration") Integer duration, @Part("reply_to_message_id") Integer replyToMessageId,
			@Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendAudio(chatId, audio, duration, replyToMessageId, replyMarkup);
	}
	...
	@Override
	public SendResponse sendAudio(@Part("chat_id") Integer chatId, @Part("audio") InputFileBytes audio,
			@Part("duration") Integer duration, @Part("reply_to_message_id") Integer replyToMessageId,
			@Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendAudio(chatId, audio, duration, replyToMessageId, replyMarkup);
	}
	...
	@Override
	public SendResponse sendDocument(@Part("chat_id") Integer chatId, @Part("document") String document,
	...
	@Override
	public SendResponse sendDocument(@Part("chat_id") Integer chatId, @Part("document") InputFile document,
			@Part("reply_to_message_id") Integer replyToMessageId, @Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendDocument(chatId, document, replyToMessageId, replyMarkup);
	}

	@Override
	public SendResponse sendDocument(@Part("chat_id") Integer chatId, @Part("document") InputFileBytes document,
			@Part("reply_to_message_id") Integer replyToMessageId, @Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendDocument(chatId, document, replyToMessageId, replyMarkup);
	}

	@Override
	public SendResponse sendSticker(@Part("chat_id") Integer chatId, @Part("sticker") String sticker,
			@Part("reply_to_message_id") Integer replyToMessageId, @Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendSticker(chatId, sticker, replyToMessageId, replyMarkup);
	}

	@Override
	public SendResponse sendSticker(@Part("chat_id") Integer chatId, @Part("sticker") InputFile sticker,
			@Part("reply_to_message_id") Integer replyToMessageId, @Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendSticker(chatId, sticker, replyToMessageId, replyMarkup);
	}

	@Override
	public SendResponse sendSticker(@Part("chat_id") Integer chatId, @Part("sticker") InputFileBytes sticker,
			@Part("reply_to_message_id") Integer replyToMessageId, @Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendSticker(chatId, sticker, replyToMessageId, replyMarkup);
	}

	@Override
	public SendResponse sendVideo(@Part("chat_id") Integer chatId, @Part("video") String video,
	...
	@Override
	public SendResponse sendVideo(@Part("chat_id") Integer chatId, @Part("video") InputFile video,
			@Part("duration") Integer duration, @Part("caption") String caption,
			@Part("reply_to_message_id") Integer replyToMessageId, @Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendVideo(chatId, video, duration, caption, replyToMessageId, replyMarkup);
	}
	...
	@Override
	public SendResponse sendVideo(@Part("chat_id") Integer chatId, @Part("video") InputFileBytes video,
			@Part("duration") Integer duration, @Part("caption") String caption,
			@Part("reply_to_message_id") Integer replyToMessageId, @Part("reply_markup") Keyboard replyMarkup) {
		return botApi.sendVideo(chatId, video, duration, caption, replyToMessageId, replyMarkup);
	}
	...
	@Override
	public SendResponse sendLocation(@Field("chat_id") Integer chatId, @Field("latitude") Float latitude,
	...
	@Override
	public GetUserProfilePhotos getUserProfilePhotos(@Query("user_id") Integer userId, @Query("offset") Integer offset,
			@Query("limit") Integer limit) {
		return botApi.getUserProfilePhotos(userId, offset, limit);
	}

	@Override
	public GetUpdatesResponse getUpdates(@Query("offset") Integer offset, @Query("limit") Integer limit,
