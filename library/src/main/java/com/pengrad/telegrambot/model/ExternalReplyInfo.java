...
public class ExternalReplyInfo implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(origin, that.origin)
                ...
                && Objects.equals(giveaway, that.giveaway)
                && Objects.equals(giveaway_winners, that.giveaway_winners)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(origin, chat, message_id, link_preview_options, animation, audio,document,photo,sticker,story,video,video_note,voice,has_media_spoiler,contact,dice,game,giveaway,giveaway_winners,invoice,location,poll,venue);
    }
